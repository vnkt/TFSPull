...
.\PsExec.exe -accepteula -h -u $theUsername -p $thePassword "C:\Program Files\Microsoft Team Foundation Server 14.0\Tools\tfsconfig.exe" unattend /configure /type:standard